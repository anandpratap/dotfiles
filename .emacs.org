...
#+BEGIN_SRC emacs-lisp
  (use-package org)
      ...
      (setq org-agenda-files (list "~/Dropbox/notes/backlogs.org" "~/Dropbox/notes/work.org" "~/Dropbox/notes/life.org"))
      ...
      (global-set-key (kbd "C-c c") 'org-capture)
        ...
        (setq org-default-notes-file "~/Dropbox/notes/backlogs.org")
        ...
        (setq org-capture-templates
              (quote (("t" "todo" entry (file "~/Dropbox/notes/backlogs.org")
                       "* TODO %i%?")
                      ("n" "Notes" entry (file "~/Dropbox/notes/backlogs.org")
                       "* NOTE %?\n%U" :empty-lines 1)
                      ("N" "Note with Clipboard" entry (file "~/Dropbox/notes/backlogs.org")
                       "* NOTE %?\n%U\n   %c" :empty-lines 1))))
