...
(use-package org)
(setq org-log-done t
          org-todo-keywords '((sequence "TODO" "INPROGRESS" "HOLD" "CANCELED" "DONE"))
    ...
    (global-set-key (kbd "C-c c") 'org-capture)
      ...
      (setq org-default-notes-file "~/test_org/refile.org")
      ...
      (setq org-capture-templates
            (quote (("t" "todo" entry (file "~/test_org/refile.org")
                     "* TODO %i%?")
                    ("r" "respond" entry (file "~/test_org/refile.org")
                     "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
                    ("n" "note" entry (file "~/test_org/refile.org")
                     "* %? :NOTE:\n%U\n%a\n")
                    ("j" "Journal" entry (file+datetree "~/test_org/diary.org")
                     "* %?\n%U\n" :clock-in t :clock-resume t)
                    ("w" "Review: Weekly Review" entry (file+datetree "~/test_org/reviews.org")
                     (file "~/test_org/weekly.org"))
                     ("m" "Meeting" entry (file "~/test_org/refile.org")
                     "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
                    ("p" "Phone call" entry (file "~/test_org/refile.org")
                     "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
                    ("h" "Habit" entry (file "~/test_org/refile.org")
